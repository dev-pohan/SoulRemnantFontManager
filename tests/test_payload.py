...
\t\tIi8vLFF(agM_aRO)''',
        ...
        self.assertIn("Ii8vLFF(sr_node)", localization)
        ...
        self.assertIn("_srfont_pending_nodes", localization)
        self.assertIn("_srfont_flush_added.call_deferred()", localization)
        self.assertIn('get_meta("_srfont_applied_generation", -1)', localization)
